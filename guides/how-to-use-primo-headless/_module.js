...
function create_fragment$4(ctx) {
	...
	component_2 = new Component$3({
			props: {
				...
				description: "",
				content: {
					"html": "<h1>How to use Primo Headless</h1><p>Download the site file &amp; loop through the content that way. </p><p>To publish Primo sites from within your existing codebase, read <a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link\" href=\"https://primocms.org/guides/using-primo-with-sveltekit\">using Primo with SvelteKit</a>. </p>",
					"markdown": "# How to use Primo Headless\n\nDownload the site file & loop through the content that way.\n\nTo publish Primo sites from within your existing codebase, read [using Primo with SvelteKit](<https://primocms.org/guides/using-primo-with-sveltekit>).\n\n"
				}
			}
		});
