...
function create_else_block$1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*breadcrumbs*/ 1 && t_value !== (t_value = /*name*/ ctx[6] + "")) set_data(t, t_value);
...
function create_each_block$1(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*i*/ ctx[8] === /*breadcrumbs*/ ctx[0].length - 1) return create_if_block_1$1;
...
function instance$4($$self, $$props, $$invalidate) {
	...
	return [content, content_node, title, description, div0_binding];
}

class Component$4 extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$4, create_fragment$4, safe_not_equal, { title: 2, description: 3, content: 0 });
	}
}
