...
function create_each_block_2(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*parent_nav*/ 4 && t_value !== (t_value = /*link*/ ctx[7].label + "")) set_data(t, t_value);

			if (dirty & /*parent_nav*/ 4 && a_href_value !== (a_href_value = /*link*/ ctx[7].url)) {
...
function instance$2($$self, $$props, $$invalidate) {
	...
	axios.get('https://primocms.org/primo.json').then(res => {
		...
		$$invalidate(2, parent_nav = header_symbol.content.en.nav);
	});
