...
function create_fragment$4(ctx) {
	...
	component_2 = new Component$3({
			props: {
				...
				content: {
					"html": "<h1>Getting Started</h1><p>Primo depends on several [freemium] third-party services for easy hosting, authentication, database and storage, etc. Running your own Primo server is as easy as forking the <a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link link link\" href=\"https://github.com/primocms/primo\"><strong>Primo repo</strong></a> and deploying it on a static host like Vercel or Netlify, which should only take a few minutes.</p><p>Third-party services (all can be signed into with Github):</p><ul><li><p>A modern web host like <a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link link link\" href=\"https://vercel.com/\"><strong>Vercel</strong></a> or <a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link link link\" href=\"https://netlify.com\"><strong>Netlify</strong></a> to host the Primo application &amp; published sites.</p></li><li><p>A <a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link link link\" href=\"https://supabase.com\"><strong>Supabase</strong></a> account to manage your server's authentication, database, and file storage.</p></li><li><p>A <a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link link link\" href=\"https://github.com\"><strong>Github</strong></a> account to deploy your sites to (unless you plan on downloading the site and connecting to a host).</p></li></ul><h2>Installation</h2><ol><li><p>Ensure you have an account with all the services listed above.</p></li><li><p>Create a new Supabase project, go to the SQL editor, add a new query and provision your project by copying the <a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link link link\" href=\"https://raw.githubusercontent.com/mateomorris/primo/master/primo_schema.sql\">schema</a> and pasting it into the editor.</p></li><li><p>Fork the <a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link link link\" href=\"https://github.com/primocms/primo\">Primo repository</a>.</p></li><li><p>Go to your web host and create a new project from your new repository, inputting your Supabase details as environment variables.</p><ul><li><p>PUBLIC_SUPABASE_URL</p></li><li><p>PUBLIC_SUPABASE_PUBLIC_KEY</p></li><li><p>PRIVATE_SUPABASE_PRIVATE_KEY</p></li></ul></li><li><p>Publish the project and navigate to the Primo authentication screen.</p></li><li><p>The user account you create will be the server owner. You can manage the entire project's data from the Supabase project dashboard.</p></li></ol>",
