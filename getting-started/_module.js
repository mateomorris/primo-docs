...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			const head_nodes = head_selector('svelte-5o43ku', document.head);
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div4, "id", "section-9fc92094-497c-4fb0-aa5e-0a92182bd95c");
		},
		m(target, anchor) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div2, "id", "section-092ada91-5fa2-4be0-b20d-446125bb9a38");
		},
		m(target, anchor) {
...
function create_fragment$4(ctx) {
	...
	component_2 = new Component$3({
			props: {
				...
				video_id: "",
				content: {
					"html": "<h1>Getting Started</h1><p>Primo depends on several [freemium] third-party services for easy hosting, authentication, database and storage, etc. Running your own Primo server is as easy as forking this repo and deploying it on a static host like Vercel or Netlify, which should only take a few minutes.</p><p>Third-party services (all can be signed into with Github):</p><ul><li><p>A modern web host like <strong>Vercel</strong> or <strong>Netlify</strong> to host the Primo application.</p></li><li><p>A <strong>Supabase</strong> account to manage your server's authentication, database, and file storage.</p></li><li><p>A <strong>Github</strong> account to deploy your sites to (unless you plan on downloading).</p></li><li><p>A static web host for the final site (can be same host used for Primo itself).</p></li><li><p>A <strong>Mailgun</strong> account for emailing collaborators with server invitations.</p></li></ul><h2>Installation</h2><ol><li><p>First, prepare your Supabase instance by copying the schema and pasting it into the SQL editor.</p></li><li><p>Then fork the <a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link\" href=\"https://github.com/primocms/primo\">Primo repository</a>.</p></li><li><p>Go to your host and create a new project from your new repository, inputting your service credentials.</p></li></ol><ul><li><p>PRIVATE_MAILGUN_KEY</p></li><li><p>PRIVATE_MAILGUN_EMAIL</p></li><li><p>PUBLIC_SUPABASE_URL</p></li><li><p>PUBLIC_SUPABASE_PUBLIC_KEY</p></li><li><p>PRIVATE_SUPABASE_PRIVATE_KEY</p></li></ul><ol start=\"4\"><li><p>Publish the project and navigate to the authentication screen. From Supabase, update the project URL (e.g. <a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link\" href=\"https://my-primo.vercel.app\">https://my-primo.vercel.app</a>).</p></li><li><p>The user account you create will be the server owner. You can manage the entire project's data from the Supabase backend.</p></li></ol>",
					"markdown": "# Getting Started\n\nPrimo depends on several [freemium] third-party services for easy hosting, authentication, database and storage, etc. Running your own Primo server is as easy as forking this repo and deploying it on a static host like Vercel or Netlify, which should only take a few minutes.\n\nThird-party services (all can be signed into with Github):\n\n- A modern web host like **Vercel** or **Netlify** to host the Primo application.\n\n- A **Supabase** account to manage your server's authentication, database, and file storage.\n\n- A **Github** account to deploy your sites to (unless you plan on downloading).\n\n- A static web host for the final site (can be same host used for Primo itself).\n\n- A **Mailgun** account for emailing collaborators with server invitations.\n\n\n<!-- -->\n\n## Installation\n\n1. First, prepare your Supabase instance by copying the schema and pasting it into the SQL editor.\n\n2. Then fork the [Primo repository](<https://github.com/primocms/primo>).\n\n3. Go to your host and create a new project from your new repository, inputting your service credentials.\n\n\n<!-- -->\n\n- PRIVATE\\_MAILGUN\\_KEY\n\n- PRIVATE\\_MAILGUN\\_EMAIL\n\n- PUBLIC\\_SUPABASE\\_URL\n\n- PUBLIC\\_SUPABASE\\_PUBLIC\\_KEY\n\n- PRIVATE\\_SUPABASE\\_PRIVATE\\_KEY\n\n\n<!-- -->\n\n4. Publish the project and navigate to the authentication screen. From Supabase, update the project URL (e.g. [https://my-primo.vercel.app](<https://my-primo.vercel.app>)).\n\n5. The user account you create will be the server owner. You can manage the entire project's data from the Supabase backend.\n\n\n<!-- -->\n\n"
				}
			}
		});
