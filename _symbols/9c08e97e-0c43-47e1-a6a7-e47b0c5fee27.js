// Site Navigation - Updated October 18, 2023
function noop() { }
const identity = x => x;
...
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			...
			toggle_class(a, "active", window.location.pathname === /*link*/ ctx[5].url);
		},
		m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	return [nav, secondary_logo, mobileNavOpen, toggleMobileNav, props];
}

class Component extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { props: 4, nav: 0, secondary_logo: 1 });
	}
}
